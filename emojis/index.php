    ...
    <script>
        document.addEventListener('DOMContentLoaded', (event) => {
            ...
            function renderEmojis(filteredEmojis) {
                ...
                filteredEmojis.forEach(el => {
                    const emoji = document.createElement('span');
                    emoji.textContent = el.emoji;
            ...
            // Dutch to English translation dictionary
            const nlToEn = {
                'glimlach': 'smil',
                'lach': 'laugh',
                'blij': 'happy',
            ...
            searchInput.addEventListener('input', (e) => {
                ...
                // Try to translate Dutch to English
                let translatedTerm = searchTerm;
                for (const [nl, en] of Object.entries(nlToEn)) {
                    if (searchTerm.includes(nl)) {
                        translatedTerm = searchTerm.replace(nl, en);
                        break;
                    }
                }
